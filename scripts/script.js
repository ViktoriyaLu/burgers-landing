...
//document.getElementsById("main-action-button").onclick = function () { //обработчик события - нажатие на кнопку
//document.getElementsById("products").scrollIntoView({behavior: "smooth"});}
